...
export default function SupporterPage() {
  ...
  useEffect(() => {
    ...
    // Pour la démo, on actualise toutes les 10 secondes
              ...
              return (
                <div key={parking.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Capacité: {parking.capacity}</span>
              ...
              <tbody>
                {trafficData.slice(0, 5).map((traffic) => (
                  <tr key={traffic.id} className="border-b">
                    <td className="px-4 py-3">{traffic.gate}</td>
                    <td className="px-4 py-3">{traffic.vehicles_in}</td>
                    <td className="px-4 py-3">{traffic.avg_speed_kmh} km/h</td>
